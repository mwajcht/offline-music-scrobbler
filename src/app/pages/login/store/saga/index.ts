...
import { LoginActionTypes, obtainSessionKeySuccess, obtainSessionKeyFailed } from '../actions';
...
export default function* loginSaga() {
  yield all([takeLatest(LoginActionTypes.OBTAIN_SESSION_KEY, executeObtainSessionKey)]);
}
